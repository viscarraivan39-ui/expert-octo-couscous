// Copia local (adaptada de geeknoticias/scripts/tendencias/obtenerTendencias.mjs)
// del feed RSS público y gratis de Google Trends — sin API key, sin librería
// (el paquete npm "google-trends-api" está roto desde que Google cambió sus
// endpoints internos).
//
// Uso: node obtenerTendencias.mjs [geo] [cantidad]
//   node obtenerTendencias.mjs CL 8

const geo = process.argv[2] || "CL";
const cantidad = parseInt(process.argv[3] || "8", 10);
