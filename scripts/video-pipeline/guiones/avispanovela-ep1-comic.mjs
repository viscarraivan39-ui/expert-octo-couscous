export const id = "avispanovela-ep1-comic";

// Misma historia que avispanovela-ep1.mjs, versión estilo cómic para
// comparar contra la hiperrealista. Mismo elenco y diálogo, solo cambia
// ESTILO y el prompt de personaje.
const ESTILO = "colorful comic book illustration style, bold outlines, flat vibrant colors, dramatic telenovela expressions, vertical composition";
